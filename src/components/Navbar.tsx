        ...
        <div className="container flex-between">
          ...
          <div className="flex-center" style={{ gap: '1rem' }}>
            ...
            <Link to="/" className="flex-center logo-link" style={{ gap: '0.5rem' }}>
              ...
              />
              <span className="heading-sm text-primary mobile-hidden" style={{ fontFamily: 'Outfit', fontWeight: 800, fontSize: '1rem' }}>
                Srivenkateshwara Enterprises
              </span>
            </Link>
          </div>
          ...
          <div className="mobile-cart-container flex-center" style={{ gap: '0.5rem' }}>
            {!user ? (
              <Link to="/login" className="btn btn-primary" style={{ padding: '0.4rem 1rem', fontSize: '0.85rem', borderRadius: '2rem' }}>
                Login
              </Link>
            ) : (
              <>
                {user.role !== 'admin' && (
                  <Link to="/cart" className="cart-btn flex-center" aria-label="View Cart" style={{ padding: '0.4rem' }}>
