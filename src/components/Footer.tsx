  ...
  return (
    <footer className="glass-dark" style={{ background: 'var(--color-bg-dark)', color: 'var(--text-light)', padding: '4rem 0 2rem 0' }}>
      <div className="container grid grid-cols-1 md:grid-cols-3" style={{ gap: '3rem' }}>
        ...
        {/* About */}
        <div>
          <h3 className="heading-sm mb-4" style={{ marginBottom: '1rem', color: 'white' }}>Srivenkateshwara Enterprises</h3>
      ...
      <div className="container" style={{ marginTop: '3rem', paddingTop: '2rem', borderTop: '1px solid rgba(255,255,255,0.1)', textAlign: 'center', color: 'var(--text-muted)' }}>
        <p>Developed by <a href="https://www.linkedin.com/in/heman-k/" target="_blank" rel="noopener noreferrer" className="text-accent hover:text-primary transition">K. Heman</a><br /> <br /> &copy; {new Date().getFullYear()} Srivenkateshwara Enterprises. All Rights Reserved. <br /><br /></p>
      </div>
    </footer>
  );
}
