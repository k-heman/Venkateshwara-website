...
function About() {
  ...
  const whatsappUrl = `https://wa.me/919553739187?text=${encodeURIComponent(whatsappMessage)}`;
  ...
  return (
    <div className="section container animate-fade-in" style={{ padding: '3rem 1.5rem', minHeight: '80vh' }}>
      <div className="text-center mb-10" style={{ marginBottom: '4rem' }}>
        <h1 className="heading-lg" style={{ marginBottom: '1rem' }}>About Srivenkateshwara Enterprises</h1>
      ...
      <div className="grid grid-cols-1 md-grid-cols-2" style={{ gap: '4rem', alignItems: 'flex-start', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))' }}>
        ...
        <div className="card glass" style={{ padding: '3rem 2rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <p className="text-muted" style={{ lineHeight: '1.8', fontSize: '1.05rem' }}>
            For over 20 years — known and loved as <strong>Heman Enterprises</strong> — we have been the go-to destination for quality home products in our community. Today, we proudly continue that legacy as <strong>Srivenkateshwara Enterprises</strong>. What started as a small neighbourhood shop has grown into a trusted name for furniture, mattresses, gas stoves, and everyday home essentials.
          </p>
          <p className="text-muted" style={{ lineHeight: '1.8', fontSize: '1.05rem' }}>
