                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '2rem' }}>
                  <div style={{ flex: 1, minWidth: '300px' }}>
                    ...
                    <p className="text-muted" style={{ fontSize: '0.9rem', maxWidth: '450px' }}>
                      Experience the best home products with Srivenkateshwara Enterprises. We'll contact you for delivery details once you checkout on My Orders section.
                    </p>
                  </div>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '2rem' }}>
                  <div style={{
                    ...
                    <p style={{ color: '#92400e', fontSize: '0.85rem', fontWeight: 600, margin: 0 }}>
                      <span style={{ fontWeight: 800 }}>Note:</span> Final delivery charges as per your location will be updated.
                    </p>
                  </div>
                  <button
